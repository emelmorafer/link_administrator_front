...
interface LinkesProps {
    enlaceProp: Enlace;
    handleClickEditLinkProp: (id: number) => void;
    handleClickDeleteLinkProp: (id: number) => void;
}

export default function Linkes({enlaceProp,handleClickEditLinkProp,handleClickDeleteLinkProp}: LinkesProps){
