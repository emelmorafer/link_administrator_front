...
interface DeleteLinkModalProps {
    ...
    setDeleteLinkAllowedProp: React.Dispatch<React.SetStateAction<boolean>>;
}

function DeleteLinkModal({showDeleteModalProp,setShowDeleteModalProp,setDeleteLinkAllowedProp} : DeleteLinkModalProps){
