...
interface FormCategoryProps {
    objectCategoryProp: Category;
    setUpdateListCategoryProp: React.Dispatch<React.SetStateAction<boolean>>;
    isEditFormProp: Boolean;
...
function FormCategory({objectCategoryProp,setUpdateListCategoryProp,isEditFormProp,
                       showModalProp,setShowModalProp} : FormCategoryProps){
    ...
    const handleSubmitCateg = async (event: FormEvent) => {
    ...
    return(
        <div className="modal" style={{display: showModalProp ? 'block' : 'none'}}>             
            <form className="creaEditForm" onSubmit={handleSubmitCateg}>
                  
                <div style={{color: 'white', padding: '10px 20px', width: '80%'}}>
                    <input
                        id="nameCateg" className="inputform"
                        type="text"
                        placeholder="Name"
                        value={nombreForm}
                    ...
                    <textarea style={{height: '90px'}}
                        id="descrCateg" className="inputform"
