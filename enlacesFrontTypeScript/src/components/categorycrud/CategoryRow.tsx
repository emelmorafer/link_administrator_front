...
interface CategoryRowProp {
    categoryProp: Category;
    handleClickEditCategoryProp: (id: number) => void;
    handleClickDeleteCategoryProp: (id: number) => void;
    handleClickListLinksCategoryProp: (id: number) => void;
}

export default function CategoryRow({categoryProp,handleClickEditCategoryProp,handleClickDeleteCategoryProp,handleClickListLinksCategoryProp} : CategoryRowProp){

    const {id,nombre,descripcion,creationdate} = categoryProp


    const [linksRelated, setLinksRelated] = useState<boolean>(false);
