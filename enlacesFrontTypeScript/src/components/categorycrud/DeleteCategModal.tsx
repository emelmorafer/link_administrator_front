...
interface DeleteCategModalProp {
    showDeleteModalProp: Boolean;
    setShowDeleteModalProp: React.Dispatch<React.SetStateAction<boolean>>;
    setDeleteCategAllowedProp: React.Dispatch<React.SetStateAction<boolean>>;
}

function DeleteCategModal({showDeleteModalProp,setShowDeleteModalProp,setDeleteCategAllowedProp} : DeleteCategModalProp){
